    ...
    <nav className="bg-white shadow-sm py-4 sticky top-0 z-30">
      <div className="container mx-auto flex justify-between items-center">
        <Link to="/" className="flex items-center space-x-2">
          <div className="h-8 w-8 rounded-full bg-emergency flex items-center justify-center">
        ...
        <div className="hidden md:flex items-center space-x-6">
          <Link to="/" className="text-gray-700 hover:text-emergency">Home</Link>
          <Link to="/doctors" className="text-gray-700 hover:text-emergency">Find Doctors</Link>
          <Link to="/about" className="text-gray-700 hover:text-emergency">About</Link>
          <Link to="/contact" className="text-gray-700 hover:text-emergency">Contact</Link>
        </div>
